    ...
    $.learuntab = {
        ...
        addTab: function () {
            ...
            if (flag) {
                ...
                var str1 = '<iframe class="LRADMS_iframe" id="iframe' + dataId + '" name="iframe' + dataId + '"  width="100%" height="100%" style="padding:40px 0px 40px 0px" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
...
//                    g.removeClass("menu-open");
                ...
                e.is(".treeview-menu");
				   if($(d).hasClass("menuItem")==true){
                	$.learuntab.refreshTab();	
                }
            });
            
			$(".treeview:first").addClass("active");
            $(".treeview-menu:first").addClass("menu-open");
            $(".treeview-menu:first").css("display","block");
        }
    };
    $(function () {
        $.learunindex.load();
