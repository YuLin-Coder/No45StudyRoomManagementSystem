					...
					'<div class="plupload">' +
						'<div class="plupload_header">' +
							'<div class="plupload_header_content">' +
								'<div class="plupload_header_title">' + _('选定文件') + '</div>' +
								'<div class="plupload_header_text">' + _('将文件添加到上载队列并单击“开始”按钮。') + '</div>' +
							'</div>' +
						'</div>' +
			...
			this.each(function() {
				...
				function updateList() {
					...
					if (!uploader.files.length && uploader.features.dragdrop && uploader.settings.dragdrop) {
						$('#' + id + '_filelist').append('<li class="plupload_droptext">' + _("拖动文件到这里.") + '</li>');
					}
				}
