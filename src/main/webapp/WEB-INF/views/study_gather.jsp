...
<div style="display:inline">
          <p style="display:inline-block;margin-top:30px"> 
              <span style="margin-left:20px;">预约日期</span>
              <input type="text" class="inpMain Wdate"  readonly="readonly"  style="color:black;width:150px;"   onFocus="WdatePicker({startDate: '%y-%M-%d' })"  placeholder="请输入预约日期最小值进行查询" id="orOrderDate1">~<input type="text" class="inpMain Wdate"  readonly="readonly"  style="color:black;width:150px;"   onFocus="WdatePicker({startDate: '%y-%M-%d' })"  placeholder="请输入预约日期最大值进行查询" id="orOrderDate2">
           </p>
      </div>

<div style="display:inline">
                       <p style="display:inline-block;margin-top:30px">
                                <a href="javascript:;"  class="btnGreen" onclick="studyGather();" style="margin-left:30px;">查询</a>
                        </p>
   </div>
<div id="studyGather" style="width: 1100px;height:400px;margin-top:30px;"></div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4350"></script>
...
<script type="text/javascript">
 ...
 function studyGather() {
	showLoading('${pageContext.request.contextPath}/static/common/loading.gif');	
	$.ajax({
		type : 'get',
		url : "${pageContext.request.contextPath}/commonapi/studyGather/studyGatherSubmit",
		data : {
					'ororderDate1':$("#orOrderDate1").val(),
					'ororderDate2':$("#orOrderDate2").val()	},
	success : function(result) {
		 hideLoading();
  var myChart = echarts.init(document.getElementById('studyGather'));
var option = {
    title : {
        text: '学习时间统计',
        subtext: '学习时间统计'
